/*
 * Created by JFormDesigner on Sat Sep 11 10:17:55 CST 2021
 */
...
public class Main {
    ...
    private void initComponents() {
        ...
        //======== 主界面 ========
        {
            主界面.setMaximumSize(new Dimension(1920, 1080));
            主界面.setMinimumSize(new Dimension(1920, 1080));
            主界面.setPreferredSize(new Dimension(1920, 1080));
            ...
            GroupLayout 主界面Layout = new GroupLayout(主界面);
            主界面.setLayout(主界面Layout);
            主界面Layout.setHorizontalGroup(
                主界面Layout.createParallelGroup()
                    .addGroup(主界面Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(主界面Layout.createParallelGroup()
                            .addComponent(menuBar1, GroupLayout.DEFAULT_SIZE, 1893, Short.MAX_VALUE)
                            .addComponent(scrollPane1, GroupLayout.DEFAULT_SIZE, 1893, Short.MAX_VALUE))
                        .addContainerGap())
            );
            主界面Layout.setVerticalGroup(
                主界面Layout.createParallelGroup()
                    .addGroup(主界面Layout.createSequentialGroup()
                        .addComponent(menuBar1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(scrollPane1, GroupLayout.DEFAULT_SIZE, 1267, Short.MAX_VALUE)
                        .addContainerGap())
            );
        }
